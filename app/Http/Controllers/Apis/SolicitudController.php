...
class SolicitudController extends Controller {
	...
	public function listadoporSolicitud($id) {
		...
		->select('s.id_solicitud', 's.id_usuario', 's.id_washer', 's.id_paquete', 's.latitud', 's.longitud', 's.fecha', 's.forma_pago', 's.cambio', 's.calificacion', DB::raw('IFNULL( s.comentario, "") as comentario'), DB::raw('IFNULL( s.foto_washer, "") as foto_washer'), 's.status', 'a.placas', 'a.modelo', 'a.ann', 'pa.nombre as paquete', 'u.nombre as usuario', 'u.foto', 'p.precio', DB::raw('IFNULL( cal.calificacion, 0) as calificacion'))
