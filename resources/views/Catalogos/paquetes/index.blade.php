...
<input type="hidden" id="url_listado" value="{{ url('paquetes/listado') }}">
<input type="hidden" id="url_datosget" value="{{ url('paquetes/datos') }}">
<input type="hidden" id="url_guardar" value="{{ url('paquetes/guardar') }}">
<input type="hidden" id="url_actualizar" value="{{ url('paquetes/update') }}">
<input type="hidden" id="url_eliminar" value="{{ url('paquetes/delete') }}">
		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<div class="row">
						<div class="col-md-7">
							<h5><i class="glyphicon glyphicon-align-justify"></i> Paquete de Lavado</h5>
						</div>
						<div class="col-md-5">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="ModalEditar">Paquetes</h4>
			</div>
			<div class="modal-body">
                <div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="descripcion-field">Precio</label>
				...
				<div class="col-md-6">
						<div class="form-group">
                        <label for="active"><input type="checkbox" class="i-checks" id="status" name="status" value="1"> Status</label>
						</div>
                    </div>
                </div>    
			</div>
...
<script src="{{ asset('js/plugins/datapicker/bootstrap-datepicker.js') }}"></script>
	...
	<script src="{{ asset('js/catalogos/paquetes.js') }}"></script>
@endsection